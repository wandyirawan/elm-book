...
updateStartSeach : Model -> ( Model, Cmd Msg )
updateStartSeach model =
...
viewSeachBar : Model -> E.Element Msg
viewSeachBar model =
    E.row
        [ E.spacing 10
        , E.paddingXY 0 12
...
viewBook book =
    let
        titleE =
            E.paragraph [ EF.bold, EF.underline, E.paddingXY 0 12 ]
                [ E.text book.title ]
            ...
            case book.pages of
                Just page ->
                    E.paragraph [ EF.size 12 ]
                        [ E.text ("(" ++ String.fromInt page ++ " pages)") ]
